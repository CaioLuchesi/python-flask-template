...
original_author="CaioLuchesi"
original_name="python_flask_template"
original_urlname="python-flask-template"
original_description="Awesome python_flask_template created by CaioLuchesi" 
...
rm -rf "${name}"
rm -rf tests
cp -R ${TEMPLATE_DIR}/python_flask_template "${name}"
...
then
    ...
    echo "then run 'python_flask_template' or 'python -m python_flask_template'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'python_flask_template' or 'python -m python_flask_template' or 'poetry run python_flask_template'"
fi
